...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'All':
        ...
        fig = px.pie(filtered_df[filtered_df['Launch Site']==entered_site], values='class_count', 
        names='class', 
...
def get_scatter_chart(entered_site, entered_slider):
    v_min, v_max = entered_slider
    filtered_df = spacex_df[(spacex_df['Payload Mass (kg)']>=v_min)&(spacex_df['Payload Mass (kg)']<=v_max)]
    if entered_site == 'All':
